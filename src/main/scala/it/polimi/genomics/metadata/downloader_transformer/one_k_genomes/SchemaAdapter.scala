...
trait MutationPrinterTrait {
   ...
   */
  def formatMutation(mutation: OKGMutation,forSample: Option[String] = None, biosamples: Option[List[String]] = None):String
}
...
class SimplePrinter extends MutationPrinterTrait {
  ...
  override def formatMutation(mutation: OKGMutation, forSample: Option[String], biosamples: Option[List[String]]): String = {
