...
/**
  ...
  */
class EncodeTransformer extends Transformer {
  ...
  /**
    ...
    */
  override def transform(source: xml.Source, originPath: String, destinationPath: String, originalFilename: String,
  ...
  /**
    ...
    */
  def transformMetaFromTsv(originPath: String, destinationFolder: String, accession: String, gmqlSource: xml.Source): Unit = {
    import scala.io.Source
  ...
  /**
    ...
    */
  def fillMetadataExclusion(source: xml.Source): Unit = {
